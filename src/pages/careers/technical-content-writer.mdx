...
up to offer breakthrough performance for time series data without the need for
expensive hardware. QuestDB was founded by a low-latency trading team and
enables companies to leverage real-time and big data processing in a wide array
of use cases and industries, from financial data to IoT and connected cars. We
are based in London and backed by leading venture capital firms and Y
Combinator.

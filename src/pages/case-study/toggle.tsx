    ...
    <MetadataContextProvider>
      <Layout description={description} title={title}>
        ...
        <section className={clsx(seCss.section, seCss["section--odd"])}>
          <div
            className={clsx(seCss["section--inner"], ouCss.outcome__wrapper)}
          >
        ...
        <section className={clsx(seCss.section, caCss.card)}>
          <p className={caCss.card__title}>
            ...
            company building state-of-the-art AI technology to help investors
            turn Big Data into investment insights.
        ...
        <section className={seCss.section}>
          ...
          >
            ...
            <p>
              ...
              turning negative for AAPL, historically this led to stock’s
              outperformance.” As you can imagine, this sort of system requires
              a tremendous amount of timeseries data — prices, fundamentals,
              sentiment, etc. All of this data is stored as series and needs to
              be easily accessible for analysis by our models. It is critical
            ...
            <p>
              ...
              time, we had a small cluster of 4 x m4.2xlarge machines, and
              memory on all 4 was often at least 80%, hitting 100% a few times
              per week. Modeling out our future infrastructure spend based on
              this baseline, we knew InfluxDB wasn’t a viable option as we
              scaled.
            </p>

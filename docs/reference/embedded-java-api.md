...
[INSERT](reference/insert.md) or [COPY](reference/copy.md) to write data, DDL such as
[CREATE TABLE](reference/create-table.md) or [SELECT](reference/select.md) to query data etc.
:::

...
InfluxDB is the current market leader in time-series, and we thought it would only be fair if we had a stab at their ingestion format called **Influx line protocol (“ILP”)** to compare data ingestion performance between QuestDB and InfluxDB.
...
![store as many](/static/img/storeasmany.png)
...
![capture rate](/static/img/capturerate.png)
...
![capture rate 2](/static/img/captureratechart.png)
>Capture rate as a function of sending speed.

![ingestion rate](/static/img/impliedspeed.png)
...
![CPU usage](/static/img/cpuinflux.png)
...
![CPU usage](/static/img/queueinflux.png)
...
![CPU parallel](/static/img/queuequest.png)
...
![CPU user](/static/img/userinflux.png)
...
![CPU User](/static/img/userquest.png)
